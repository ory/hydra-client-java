...
# Contribute to Ory Ory Hydra Java Client<!-- omit in toc -->
...
[open a well-written issue or discussion](https://github.com/ory/hydra-client-java/issues):
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Hydra Java Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/hydra-client-java/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory Ory Hydra Java Client, please follow these
guidelines:
...
git clone git@github.com:ory/hydra-client-java.git
